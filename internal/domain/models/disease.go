...
type Disease struct {
	...
	CvdsPredisposition   bool   `json:"cvdsPredisposition" db:"cvds_predisposition"`
	TakeStatins          bool   `json:"takeStatins" db:"take_statins"`
	Ckd                  bool   `json:"ckd" db:"ckd"`
	ArterialHypertension bool   `json:"arterialHypertension" db:"arterial_hypertension"`
	CardiacIschemia      bool   `json:"cardiacIschemia" db:"cardiac_ischemia"`
	TypeTwoDiabets       bool   `json:"typeTwoDiabets" db:"type_two_diabets"`
	InfarctionOrStroke   bool   `json:"infarctionOrStroke" db:"infarction_or_stroke"`
	Atherosclerosis      bool   `json:"atherosclerosis" db:"atherosclerosis"`
	OtherCvdsDiseases    bool   `json:"otherCvdsDiseases" db:"other_cvds_diseases"`
}
